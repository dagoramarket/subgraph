...
export function handleListingCancelled(event: ListingCancelled): void {
  ...
  //
  // - contract.MINIMUM_STAKED_TOKEN(...)
  // - contract.PERCENTAGE_BURN(...)
  // - contract.cancelledListings(...)
  // - contract.createListing(...)
  // - contract.disputeManager(...)
  // - contract.managerAllowed(...)
  // - contract.owner(...)
  // - contract.requireValidListing(...)
  // - contract.stakeManager(...)
  // - contract.updateListing(...)
}
